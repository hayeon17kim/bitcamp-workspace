...
public interface A {
  ...
  // 특정 인스턴스에 종속되지 않고 작업하는 경우에 static메서드로 정의한다.
  static String m1() {
    // 인스턴스 없이 수행하는 작업을 여기에 작성
    return "안녕하세요!";
  }
  ...
  // static 메서드나 default메서드가 여러개 있어도 구현된 메서드이기 ㄸ매ㅜㄴ에
  // 추상 메서드와는 상관 없다. 따라서 이 인터페이스는 추상 메서드가 한 개다.
  // 즉 람다로 구현할 수 있다.
  // 람다 표현식이란?
  void m3();
}
