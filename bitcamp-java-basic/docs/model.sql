...
CREATE TABLE lms_stud (
	...
	acnt  VARCHAR(255) NULL     COMMENT '계좌번호', -- 계좌번호
	elno  INTEGER      NULL     COMMENT '학력번호', -- 학력번호
	schno INTEGER      NULL     COMMENT '학교번호', -- 학교번호
	majno INTEGER      NULL     COMMENT '전공번호', -- 전공번호
...
CREATE TABLE lms_lect (
	...
	title   VARCHAR(255) NULL     COMMENT '과정명', -- 과정명
...
CREATE TABLE lms_appl (
	...
	lno  INTEGER  NULL     COMMENT '교육과정번호', -- 교육과정번호
	cdt  DATETIME NULL     DEFAULT now() COMMENT '신청일', -- 신청일
...
CREATE TABLE lms_user (
	...
	el       VARCHAR(30)  NULL     COMMENT '전화', -- 전화
...
CREATE TABLE lms_school (
	...
	title VARCHAR(50) NULL     COMMENT '학교명' -- 학교명
)
COMMENT '학교';
...
CREATE TABLE lms_major (
	...
	title VARCHAR(50) NULL     COMMENT '전공명' -- 전공명
)
COMMENT '전공';
...
CREATE TABLE lms_room (
	...
	title VARCHAR(50) NULL     COMMENT '교실명', -- 교실명
	capa  INTEGER     NULL     COMMENT '수용인원' -- 수용인원
)
COMMENT '교실';
...
CREATE TABLE lms_center (
	...
	title VARCHAR(50) NULL     COMMENT '지점명' -- 지점명
)
COMMENT '지점';
